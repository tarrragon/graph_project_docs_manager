...
**教材**（規劃在序列裡的章節與文章）：`description` 說這一篇涵蓋什麼、交付哪一段觀念。**觸發條件式在這裡是缺陷**——以「⋯⋯時」收尾、「想知道 / 想確認 / 想判斷」起手、把症狀寫在前面、或寫成問句，這四種都要換掉。理由是框架會反過來決定文章：那句話寫成「遇到 X 時」，文章就得是 X 的答案，而教材照問題組織會產生斷點——讀者不曾遇到那個問題，就永遠不會知道有那件事。文章從標題發想、`description` 從文章發想，順序不能反。
