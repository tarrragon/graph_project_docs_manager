...
**指名複核者的人工複核，驗收條件須寫三項**：複核者（該維度權威來源 skill／方法論的既有審查角色，或本框架既有審查代理人；不得留白等待指派）、複核依據（該維度權威原文中最接近的判準條款，供複核者比對）、複核產出（一句合格／不合格的結論加理由，寫入該張地基票的 Solution）。機械檢查形態本身留給各維度依其權威自行設計，本 skill 不代為規定——權威若本身未提供機械檢查判準，屬〈權威缺席時〉「框架內確實無承接者」的判準層缺口，另標「無判準」建框架缺口票，不在步驟 5 解決。
