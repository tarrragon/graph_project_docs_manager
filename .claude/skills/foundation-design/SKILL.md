...
| **待定** | 該維度**該判而未能判**：權威缺席，或說不出它要防的失效在本專案長成什麼樣子。**判不出來一律填「待定」，任何情況下都不得以「無」代之**。權威存在但無可用部分屬判準層，另標「無判準」，單獨不構成填「待定」的理由（見〈權威缺席時〉）——那是判準層的結論，不是產物欄的答案，兩層分開填 | 缺的是什麼 + 一張補它的票；該維度的地基票 `blockedBy` 它 |
