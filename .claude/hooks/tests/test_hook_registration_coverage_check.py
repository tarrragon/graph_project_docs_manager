"""
Test: hook-registration-coverage-check._format_permission_report（0.2.1-W3-499 AC2）
...
HOOK_PATH = HOOKS_DIR / "hook-registration-coverage-check.py"


def _load_hook_module():
    spec = importlib.util.spec_from_file_location(
        "hook_registration_coverage_check_permission_report_under_test", HOOK_PATH
    )
