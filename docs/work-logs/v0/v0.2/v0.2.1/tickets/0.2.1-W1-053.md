...
acceptance:
- '[ ] 新增測試：有開放後繼時回後繼、無後繼時回 patch+1／minor+1，皆通過'
- '[ ] 對照測試：同 fixture 下複本與 ticket lib 結果逐案相等'
- '[ ] 本專案實跑 version-release check --version 0.2.1，6 張前移目標皆為 v0.3.0'
- '[ ] SKILL.md 補述、CHANGELOG 版號 +1；skill 測試全綠'
tdd_phase: phase1
tdd_stage:
- phase1
- phase2
