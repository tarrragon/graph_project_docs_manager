...
<!-- auto-extracted: v1 | sources: 0.1.0-W3-335.11 | chars: 225 -->

### Task Reference
- 0.1.0-W3-335.11 what: 修補 tdd 的 spec/UC 轉測試缺引導（G10–G13）

### Rationale Chain
- 0.1.0-W3-335.11 why: W3-332 審查與走查確認 agent 依此文件推導元件與測試時被迫猜測或讀出兩種做法；缺口編號與來源見 W3-332.13 Solution，並以 W3-332 Problem Analysis〈PM 審查彙整草稿〉P1–P9 修正

### Source Acceptance (reference)
- [ref] [ ] 替代與例外場景歸屬、無 UC 步驟的 FR、模組群組切法、多來源取最具體四項補文字約束  # from 0.1.0-W3-335.11
- [ref] [ ] 引用 W3-332.3 草稿者標明採用或修改理由  # from 0.1.0-W3-335.11
