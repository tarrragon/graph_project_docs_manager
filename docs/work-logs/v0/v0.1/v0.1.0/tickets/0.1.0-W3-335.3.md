...
<!-- auto-extracted: v1 | sources: 0.1.0-W3-335.2 | chars: 231 -->

### Task Reference
- 0.1.0-W3-335.2 what: 修補 ux-design-evaluation 缺引導（G28–G33）

### Rationale Chain
- 0.1.0-W3-335.2 why: W3-332 審查與走查確認 agent 依此文件推導元件與測試時被迫猜測或讀出兩種做法；缺口編號與來源見 W3-332.13 Solution，並以 W3-332 Problem Analysis〈PM 審查彙整草稿〉P1–P9 修正

### Source Acceptance (reference)
- [ref] [ ] 每項補上文字約束，引用 W3-332.6 草稿者標明採用或修改理由  # from 0.1.0-W3-335.2
- [ref] [ ] 新約束逐條套〈何處需要範例〉判準並記錄是否轉為缺範例  # from 0.1.0-W3-335.2
- [ref] [ ] 不寫範例本體  # from 0.1.0-W3-335.2
